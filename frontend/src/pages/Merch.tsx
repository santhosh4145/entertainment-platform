...
import { Flame, ShoppingBag, ShoppingCart, ArrowLeft, Package, Loader2 } from "lucide-react"
...
export default function Merch() {
  const { addItem, items: cartItems, removeItem, totalItems, totalPrice, clearCart } = useCartStore()
            ...
            {filteredItems.map((item, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-white/30 text-xs mb-4 leading-relaxed line-clamp-2">{item.description}</p>
